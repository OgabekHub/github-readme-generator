...
const SKILL_CATEGORIES = {
  ...
  if (data.show3dContrib && data.github) {
    ...
    lines.push('')
    lines.push('<details>')
    lines.push('<summary>⚙️ <b>3D widgetni o\'rnatish yo\'riqnomasi</b> (ko\'rish uchun bosing)</summary>')
    lines.push('')
  ...
  if (data.showSnakeAnimation && data.github) {
    ...
    lines.push('')
    lines.push('<details>')
    lines.push('<summary>⚙️ <b>Snake animatsiyasini o\'rnatish yo\'riqnomasi</b> (ko\'rish uchun bosing)</summary>')
    lines.push('')
    lines.push('> 1. `' + data.github + '/' + data.github + '` reponi oching')
    ...
    lines.push('>           outputs: dist/github-contribution-grid-snake.svg?palette=github-dark')
